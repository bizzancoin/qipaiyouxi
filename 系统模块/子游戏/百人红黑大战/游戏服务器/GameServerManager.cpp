...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("RedBlack.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("RedBlackServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
VOID * CGameServiceManager::CreateAndroidUserItemSink(REFGUID Guid, DWORD dwQueryVer)
{
	try
	{
		...
		{
			m_AndroidServiceHelper.SetModuleCreateInfo(TEXT("RedBlackAndroid.dll"),"CreateGameServiceManager");
...
HWND CGameServiceManager::CreateCustomRule( CWnd * pParentWnd, CRect rcCreate, LPBYTE pcbCustomRule, WORD wCustonSize )
{
	...
	hDllInstance = AfxLoadLibrary(TEXT("RedBlackAndroid.dll"));
