...
protected:
    ...
    double				    m_dMaxRoomStorage[2];						//库存上限
    WORD					m_wRoomStorageMul[2];						//赢分概率
    double				    m_dRoomStorageCurrent;						//库存数值
    double				    m_dRoomStorageDeduct;						//库存衰减
...
public:
    //设置房间库存
    virtual void SetRoomStorage(double dRoomStartStorage, double dRoomCurrentStorage);
