...
bool __cdecl CGameVideoItemSink::StopAndSaveVideo(WORD wServerID, WORD wTableID, WORD wPlayCount)
{
	//保存到数据库
...
bool __cdecl CGameVideoItemSink::AddVideoData(WORD wMsgKind, VOID *pData, size_t sDataSize, bool bFirst)
{
	if (bFirst) WriteUint16(wMsgKind);
	Write(pData, sDataSize);
	return TRUE;
}
