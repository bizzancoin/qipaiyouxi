<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatOnlineInfo.aspx.cs" Inherits="Game.Web.Module.AppManager.StatOnlineInfo" %>
    ...
    <div>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                <td class="listTitle">统计时间</td>
                <td class="listTitle2">在线人数</td>           
            </tr>
            <asp:Repeater ID="rptOnLineStream" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                    onmouseout="this.style.backgroundColor=currentcolor">                  
                        <td><%# Eval("InsertDateTime")%></td>
                        <td><%# Eval("OnLineCountSum")%></td>
                    </tr>
                </ItemTemplate>
