<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameTaxStat.aspx.cs" Inherits="Game.Web.Module.DataAnalysis.GameTaxStat" %>
...
<body>
    ...
    <div style="height:30px; width:97%; margin-top:10px;">
        <div style="margin-left:10px;font-size:14px; font-weight:bold; float:left;">游戏税收统计图</div>
        <div class="xuxian"></div>
    </div>
    <div style="margin-left:120px; clear:both;">
           统计每日游戏税收：<asp:TextBox ID="txtStartDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'txtEndDate\')}'})"></asp:TextBox><img
                    ...
                    <input type="button" onclick="Redirect('GameTaxStat.aspx');" class="btn wd1" value="刷新" />
                    <input type="button" value="查看详情报告" class="btn" style="width:120px;" onclick="javascript:openWindowOwn('GameTaxList.aspx?startDateID=<%= startDateID %>&endDateID=<%= endDateID %>', 'GameTaxList', 700, 500);" />
    </div>
        ...
        <asp:Chart ID="Chart1" runat="server" Width="950" Height="300" BorderColor="26, 59, 105"
            ...
            <ChartAreas>
                <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                    ...
                    <AxisY LineColor="64, 64, 64, 64" IsLabelAutoFit="False" Title="每日游戏税收" TitleAlignment="Far"
                        ArrowStyle="none">
                ...
                <Titles>
                <asp:Title Text="【游戏税收日统计图】" ToolTip="游戏税收日统计图" Font="Microsoft Sans Serif, 10pt">
                </asp:Title>
            </Titles>
        </asp:Chart>
    </div>
    ...
    <div style="width:100%; float:left; height:200px;margin-top:10px;">
        <asp:Chart ID="Chart2" runat="server" Width="950" Height="250" BorderColor="26, 59, 105"
            ...
            <ChartAreas>
                <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                    BackSecondaryColor="White" BackColor="#FFFFFF" ShadowColor="Transparent">
                    <AxisY LineColor="64, 64, 64, 64" IsLabelAutoFit="False" Title="每月游戏税收" TitleAlignment="Far"
                        ArrowStyle="none">
                        <LabelStyle Font="Trebuchet MS, 8.25pt, style=Bold" />
                        <MajorGrid Interval="Auto" LineColor="64, 64, 64, 64" />
                        <MajorTickMark Interval="1" Enabled="False" />
            ...
            <Titles>
                <asp:Title Text="【游戏税收月统计图】" ToolTip="游戏税收月统计图" Font="Microsoft Sans Serif, 10pt">
                </asp:Title>
            </Titles>
        </asp:Chart>
    </div>
