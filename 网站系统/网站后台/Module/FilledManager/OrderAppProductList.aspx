<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderAppProductList.aspx.cs" Inherits="Game.Web.Module.FilledManager.OrderAppProductList" %>
...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <input id="btnNew1" type="button" class="btn wd1" value="新建" onclick="Redirect('OrderAppProductInfo.aspx')" />
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                             <%# "<input name='cid' type='checkbox' value='" + Eval("AppID").ToString() + "'/>" %>
                        </td>
                        <td>
                           <a href="OrderAppProductInfo.aspx?param=<%# Eval( "AppID" ).ToString( )%>" class="l">更新</a>
                        </td>
                        <td>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="OpList">
        <tr>
            <td class="titleOpBg Lpd10">
                <input id="btnNew2" type="button" class="btn wd1" value="新建" onclick="Redirect('OrderAppProductInfo.aspx')" />
                 <input class="btnLine" type="button" /> 
