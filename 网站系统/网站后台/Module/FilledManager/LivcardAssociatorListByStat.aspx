<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LivcardAssociatorListByStat.aspx.cs" Inherits="Game.Web.Module.FilledManager.LivcardListByStat" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="39" class="titleOpBg">
                ...
                <asp:Button ID="btnDisable" runat="server" Text="禁用" CssClass="btn wd1" OnClick="btnDisable_Click" OnClientClick="return selectitem()" />
                <asp:Button ID="btnEnable" runat="server" Text="启用" CssClass="btn wd1" OnClick="btnEnable_Click" OnClientClick="return selectitem()" />
            </td>
        </tr>
    </table>
    <div id="content">
