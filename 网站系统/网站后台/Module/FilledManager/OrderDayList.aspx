<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDayList.aspx.cs" Inherits="Game.Web.Module.FilledManager.OrderDayList" %>
...
<body>
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            ...
            <asp:Repeater ID="rptDayDetail" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        onmouseout="this.style.backgroundColor=currentcolor">
                        <td>
                            <%# ( string )Eval( "Status" ) == "055" ? "&nbsp;" : "<input name='cid' type='checkbox' value='" + Eval( "DetailID" ) + "'/>"%>
                        </td>
                        <td>
                            <%# Eval( "OrderID" )%>
                        </td>
                        ...
                        <td>
                            <%#  PayType.GetDayPayType( Eval("PayType").ToString() ) %>
                        </td>
                        <td>
                            <%# Eval("InputDate")%>
                        </td>
                        <td>
                            <%# (string)Eval("Status") == "055" ? "<span class='lan'>成功<span>" : "<span class='hong'>失败("+PayMessage.GetDayPayMessage( Eval("Status").ToString() )+")<span>"%>
                        </td>
                    </tr>
                </ItemTemplate>
