<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PcGameList.aspx.cs" Inherits="Game.Web.Module.AgentManager.PcGameList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td class="titleOpBg Lpd10">
                <input type="button" value="新增" class="btn wd1" onclick="openWindowOwn('PcGameInfo.aspx?cmd=add&AgentID=<%=IntParam %>    ', 'addPcGame', 600, 300)" />
            ...
            <asp:Repeater ID="rptGameList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>                             
                            <a class="l" href="javascript:void(0);" onclick="openWindowOwn('PcGameInfo.aspx?param=<%#Eval("ID").ToString() %>','<%#Eval("ID").ToString() %>_PcGame',600,300);">更新</a>              
                        </td>   
                        <td><%# Eval("KindID")%></td>
