<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentRevenueList.aspx.cs" Inherits="Game.Web.Module.AgentManager.AgentRevenueList" %>
                ...
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td title="<%# GetAccounts((int)Eval( "UserID" ))%>">
                            <a class="l" href="javascript:void(0);" onclick="openWindowOwn('/Module/AccountManager/AccountsInfo.aspx?param=<%#Eval("UserID").ToString() %>','<%#Eval("UserID").ToString() %>',850,670);">
                                <%#Game.Utils.TextUtility.CutString(GetAccounts((int)Eval( "UserID" )),0,10)%></a>
                        </td>
                        <td>
                            <%# Eval( "Revenue" ) %>
                        </td>
                        <td title="<%# GetAccounts((int)Eval( "AgentUserID" ))%>">
                            <a class="l" href="javascript:void(0);" onclick="openWindowOwn('AgentManager.aspx?param=<%#Eval("AgentUserID").ToString() %>','<%#Eval("AgentUserID").ToString() %>',850,670);">
                                <%#Game.Utils.TextUtility.CutString(GetAccounts((int)Eval( "AgentUserID" )),0,10)%></a>
                        </td>
                        <td>
                            <%# Eval( "AgentRevenue" ) %>
                        </td>                         
                        ...
                        <td>
                            <%# (int)((decimal)Eval( "CompanyScale" )*1000) %>‰
                        </td>
                        <td>
                            <%# Eval("CollectDate") %>
                        </td>
