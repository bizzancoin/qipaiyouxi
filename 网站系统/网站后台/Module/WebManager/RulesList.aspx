<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RulesList.aspx.cs" Inherits="Game.Web.Module.WebManager.RulesList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('RulesInfo.aspx?cmd=add')" />
            ...
            <asp:Repeater ID="rptRules" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        ...
                        <td>                             
                            <a class="l" href="RulesInfo.aspx?cmd=edit&param=<%#Eval("KindID") %>">更新</a>              
                        </td>                
                        <td><%# Eval("KindID")%></td>
                        <td><%# Eval("KindName")%></td>
