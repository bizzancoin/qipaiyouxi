<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardNoticeList.aspx.cs" Inherits="Game.Web.Module.WebManager.CardNoticeList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('CardNoticeInfo.aspx?cmd=add')" />
            ...
            <asp:Repeater ID="rptNews" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        ...
                        <td>                             
                            <a class="l" href="CardNoticeInfo.aspx?cmd=edit&param=<%# Eval("NewsID") %>">更新</a>              
                        </td>                
                        <td><%# Eval("Subject")%></td>
