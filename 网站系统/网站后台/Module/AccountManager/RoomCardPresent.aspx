<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoomCardPresent.aspx.cs" Inherits="Game.Web.Module.AccountManager.RoomCardPresent" %>
            ...
            <asp:Repeater ID="rptRoomCard" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# GetAccounts(Convert.ToInt32(Eval("TargetUserID")))%>
                        </td>
                        <td>
                            <%# Eval("TBeforeCard")%>
                        </td>
                        <td>
                            <%# Convert.ToInt32(Eval("TBeforeCard")) + Convert.ToInt32(Eval("RoomCard")) %>
                        </td>
                        <%--<td>
                            <%# Eval("Remarks")%>
                        </td>--%>
