<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantGameIDList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordGrantGameIDList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "CurGameID" ).ToString( )%>
                        </td>
                        <td>
                            <%# Eval( "ReGameID" ).ToString( )%>
                        </td>
                        <td>
                            <%# Eval( "IDLevel" ).ToString( )%>
                        </td>
                        <td>
