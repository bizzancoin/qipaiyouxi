<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoomCardPay.aspx.cs" Inherits="Game.Web.Module.AccountManager.RoomCardPay" %>
            ...
            <asp:Repeater ID="rptRoomCard" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Convert.ToInt32(Eval("BeforeRoomCard"))+Convert.ToInt32(Eval("RoomCard")) %>
                        </td>
                        <td>
                            <%# Eval("IPAddress")%>
                        </td>
