<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsGrantTreasureList.aspx.cs"
    Inherits="Game.Web.Module.AccountManager.AccountsGrantTreasureList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Convert.ToInt64( Eval( "CurGold" ) ).ToString( "N0" )%>
                        </td>
                        <td>
                            <%# Convert.ToInt64( Eval( "AddGold" ) ).ToString( "N0" )%>
                        </td>
                        <td>
                            <%# ( Convert.ToDouble( Eval( "CurGold" ).ToString() ) + Convert.ToDouble( Eval( "AddGold" ).ToString() ) ) < 0 ? "0" : ( Convert.ToDouble( Eval( "CurGold" ).ToString() ) + Convert.ToDouble( Eval( "AddGold" ).ToString() ) ).ToString( "N0" )%>
                        </td>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td align="right" class="page">
                <gsp:AspNetPager ID="anpNews" runat="server" AlwaysShow="true" FirstPageText="首页"
                    LastPageText="末页" PageSize="20" NextPageText="下页" PrevPageText="上页" ShowBoxThreshold="0"
                    ShowCustomInfoSection="Left" LayoutType="Table" NumericButtonCount="5" CustomInfoHTML="总记录：%RecordCount%　页码：%CurrentPageIndex%/%PageCount%　每页：%PageSize%"
                    UrlPaging="True">
                </gsp:AspNetPager>
            </td>
        </tr>
