            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td style="width: 30px;">
                            <input name='cid' type='checkbox' value='<%#  Eval("ContentID").ToString() %>' />
                        </td>
                        <td>
                            <%# anpNews.PageSize * ( anpNews.CurrentPageIndex - 1 ) + ( Container.ItemIndex + 1 )%>
                        </td>
                        <td style="width: 100px;">
                            <a class="l" href="<%#"ConfineContenInfo.aspx?param="+Eval("ContentID").ToString()+"&reurl="+ Game.Utils.Utility.CurrentUrl %>">
                                更新</a>
                            <a class="l" href="ConfineContentList.aspx?cmd=del&param=<%#Eval("ContentID") %>" onclick="return confirm('确定要删除吗？')">删除</a>
                        </td>
                        <td>
