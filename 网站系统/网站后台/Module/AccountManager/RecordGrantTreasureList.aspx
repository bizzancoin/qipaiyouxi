<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantTreasureList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordGrantTreasureList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "AddGold" ).ToString( )%>
                        </td>
                        <td>
                            <%# ( Convert.ToDouble( Eval( "CurGold" ).ToString( ) ) + Convert.ToDouble( Eval( "AddGold" ).ToString( ) ) )< 0 ? "0": ( Convert.ToDouble( Eval( "CurGold" ).ToString( ) ) + Convert.ToDouble( Eval( "AddGold" ).ToString( ) ) ).ToString()%>
                        </td>
                        <td>
