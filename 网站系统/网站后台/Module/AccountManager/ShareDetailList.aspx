    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">帐号</td>         
                <td class="listTitle2">游戏ID</td>         
                <td class="listTitle2">订单号码</td> 
                <td class="listTitle2">实卡卡号</td>        
                <td class="listTitle2">卡名称</td>       
                <td class="listTitle2">充值游戏豆</td>
                <td class="listTitle2">充值前游戏豆</td>    
            ...
            <asp:Repeater ID="rptShareDetail" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">               
                        ...
                        <td><%# Eval("OrderID")%></td> 
                        <td><%# Eval("SerialID")%></td>   
                        <td><%# GetCardTypeName(int.Parse(Eval( "CardTypeID" ).ToString()))%></td>
                        <td><%# Eval( "Currency" )%></td>
                        <td><%# Eval( "BeforeCurrency" )%></td>
