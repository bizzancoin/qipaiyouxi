<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantRoomCard.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordGrantRoomCard" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "CurRoomCard" ).ToString( )%>
                        </td>
                        <td>
                            <%# Eval( "AddRoomCard" ).ToString( )%>
                        </td>
                        <td>
                            <%# Convert.ToInt32( Eval( "CurRoomCard" ).ToString( ) ) + Convert.ToInt32( Eval( "AddRoomCard" ).ToString( ) )%>
                        </td>
                        <td>
