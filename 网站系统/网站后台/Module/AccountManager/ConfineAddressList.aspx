...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtSearch" runat="server" CssClass="text" ToolTip="输入IP地址"></asp:TextBox>
                ...
                <input type="button" value="IP地址注册数TOP100" class="btn" style="width:120px;" onclick="javascript:openWindowOwn('ConfineAddressTop.aspx', 'ConfineAddressTop', 700, 500);" />
            </td>
        </tr>
    </table>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('ConfineAddressInfo.aspx')" />
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td style="width: 100px;">
                            <a class="l" href="<%#"ConfineAddressInfo.aspx?param="+Eval("AddrString").ToString()+"&reurl="+ Server.UrlEncode(Game.Utils.Utility.CurrentUrl) %>">
                                更新</a>
                ...
                <AlternatingItemTemplate>
                    <tr align="center" class="listBg" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td style="width: 100px;">
                            <a class="l" href="<%#"ConfineAddressInfo.aspx?param="+Eval("AddrString").ToString()+"&reurl="+ Game.Utils.Utility.CurrentUrl %>">
                                更新</a>
                            <a class="l" href="ConfineAddressList.aspx?cmd=del&param=<%#Eval("AddrString") %>" onclick="return confirm('确定要删除吗？')">删除</a>
                        </td>
                        <td>
