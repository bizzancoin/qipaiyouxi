...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtGameID" runat="server" CssClass="text wd4" MaxLength="16" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>
    ...
    <script>
        $(document).ready(function() {
            $("#<%=txtGameID.ClientID %>").val($("#<%=ddlGameID.ClientID %>").val());
            $("#<%=ddlGameID.ClientID %>").change(function() {
                $("#<%=txtGameID.ClientID %>").val($(this).val());
            });
        });
