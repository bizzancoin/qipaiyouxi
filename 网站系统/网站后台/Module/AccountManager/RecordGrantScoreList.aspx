<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantScoreList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordGrantScoreList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# GetGameKindName( Convert.ToInt32(Eval( "KindID" ).ToString( )))%>
                        </td>
                        <td>
                            <%# Eval( "CurScore" ).ToString( )%>
                        </td>
                        <td>
                            <%# Eval( "AddScore" ).ToString( )%>
                        </td>
                        <td>
