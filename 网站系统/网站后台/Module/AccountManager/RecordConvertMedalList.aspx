            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# ( Convert.ToInt64( Eval( "CurInsureScore" ).ToString() ) + Convert.ToInt64( Eval( "ConvertUserMedal" ).ToString() ) * Convert.ToInt64( Convert.ToDouble( Eval( "ConvertRate" ).ToString() ) ) ).ToString( "N0" )%>
                        </td>
                        <td>
                            1:<%# Convert.ToInt32( Eval( "ConvertRate" ) )%>
                        </td>
                        <td>
