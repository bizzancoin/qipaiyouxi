<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordUserScoreInoutList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordUserScoreInoutList" %>
            ...
            <asp:Repeater ID="rptUserInout" runat="server" OnItemDataBound="rptUserInout_ItemDataBound">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td title="<%# GetAddressWithIP( Eval("EnterClientIP").ToString())%>">
                            <%# Eval( "EnterClientIP" ).ToString( )%>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Label ID="lblLeaveReason" runat="server"></asp:Label>
                        </td>
                        ...
                        <%# Eval("LeaveTime") == DBNull.Value ? "<td></td>" : "<td>" + Eval("LeaveMachine") + "</td>"%>
                    </tr>
                </ItemTemplate>
