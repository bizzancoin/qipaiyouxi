<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantExperienceList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordGrantExperienceList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "CurExperience" ).ToString( )%>
                        </td>
                        <td>
                            <%# Eval( "AddExperience" ).ToString( )%>
                        </td>
                        <td>
                            <%# Convert.ToInt64( Eval( "CurExperience" ).ToString( ) ) + Convert.ToInt64( Eval( "AddExperience" ).ToString( ) )%>
                        </td>
                        <td>
