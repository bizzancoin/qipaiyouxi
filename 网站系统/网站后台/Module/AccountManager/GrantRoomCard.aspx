<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrantRoomCard.aspx.cs" Inherits="Game.Web.Module.AccountManager.GrantRoomCard" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAddCard" runat="server" CssClass="text wd4" MaxLength="16" onkeyup="if(isNaN(value))execCommand('undo');"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
