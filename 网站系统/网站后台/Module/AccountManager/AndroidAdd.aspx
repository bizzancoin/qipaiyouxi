<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AndroidAdd.aspx.cs" Inherits="Game.Web.Module.AccountManager.AndroidAdd" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        <tr>
            <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10"><div class="hg3  pd7">
                <asp:Literal ID="litInfo" runat="server"></asp:Literal>新增机器人</div></td>
        </tr>
        <tr>
            <td class="listTdLeft">新增方式：</td>
            <td>        
        ...
        <tr>
            <td class="listTdLeft"><asp:Label ID="lblAndroidName" runat="server" Text="机器人帐号："></asp:Label></td>
            <td>        
        ...
        <tr>
            <td class="listTdLeft">
             服务时间：<br />
             （<input id="chkAll" type="checkbox" /><label for="chkAll">全选</label>）
            </td>
