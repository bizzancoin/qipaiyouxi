<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameNodeItemInfo.aspx.cs" Inherits="Game.Web.Module.AppManager.GameNodeItemInfo" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        <tr>
            <td height="35" colspan="2" class="f14 bold Lpd10 Rpd10">
                <div class="hg3  pd7">
                    <asp:Literal ID="litInfo" runat="server"></asp:Literal>节点信息</div>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtNodeID" runat="server" CssClass="text" onkeyup="if(isNaN(value))execCommand('undo');" MaxLength="9"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtNodeName" runat="server" CssClass="text" MaxLength="32"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
