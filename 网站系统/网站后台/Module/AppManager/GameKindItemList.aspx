<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameKindItemList.aspx.cs" Inherits="Game.Web.Module.AppManager.GameKindItemList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('GameKindItemInfo.aspx?cmd=add')" />
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">游戏类型</td>    
                <td class="listTitle2">排序</td> 
                <td class="listTitle2">进程名称</td>  
                <td class="listTitle2">游戏属性</td>  
                <td class="listTitle2">规则路径</td>  
                <td class="listTitle2">下载路径</td> 
                <td class="listTitle1">是否推荐</td>              
            ...
            <asp:Repeater ID="rptGameKindItem" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        ...
                        <td>                             
                            <a class="l" href="GameKindItemInfo.aspx?cmd=edit&param=<%#Eval("KindID") %>">更新</a>              
                        </td>          
                        <td><%# Eval("KindID")%></td>           
                        <td><%# Eval("KindName")%></td>
                        <td><%# GetGameTypeName((int)Eval("TypeID"))%></td>
                        <td><%# Eval("SortID")%></td>
                        <td><%# Eval("ProcessName")%></td>
                        <td><%# GetGameFlagName((int)Eval("GameFlag")) %></td>
                        <td><%# Eval("GameRuleUrl")%></td>
                        <td><%# Eval("DownLoadUrl")%></td>
                        <td><%# GetRecommendName((int)Eval( "Recommend" ))%></td>
