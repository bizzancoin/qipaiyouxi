<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SensitiveWordsList.aspx.cs" Inherits="Game.Web.Module.AppManager.SensitiveWordsList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('SensitiveWordsInfo.aspx?cmd=add')" />             
            </td>
        </tr>
    </table>  
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">过滤关键字</td>             
            </tr>
            <asp:Repeater ID="rptDataBase" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                    onmouseout="this.style.backgroundColor=currentcolor">
                        <td><input name='cid' type='checkbox' value='<%# Eval("ForbidWords")%>'/></td>                    
                        <td><%# Eval("ForbidWords")%></td>
                    </tr>
                </ItemTemplate>
