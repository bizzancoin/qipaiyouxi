<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameNodeItemList.aspx.cs" Inherits="Game.Web.Module.AppManager.GameNodeItemList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('GameNodeItemInfo.aspx?cmd=add')" />
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        <td><input name='cid' type='checkbox' value='<%# Eval("NodeID")%>'/></td>      
                        <td>                             
                            <a class="l" href="GameNodeItemInfo.aspx?cmd=edit&param=<%#Eval("NodeID") %>">更新</a>              
                        </td>                
                        <td><%# Eval( "NodeID" )%></td>
                        <td><%# Eval( "NodeName" )%></td>
                        <td><%# GetGameKindName(int.Parse( Eval( "KindID" ).ToString()))%></td>
                         <td><%# GetGameNodeName(int.Parse(Eval( "JoinID" ).ToString()))%></td>
                        <td><%# Eval("SortID")%></td>
