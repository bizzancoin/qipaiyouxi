<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdCourse.aspx.cs" Inherits="Game.Web.Service.AdCourse" %>
              ...
              <div class="ui-faq-box">
                <ul class="ui-faq-list">
                    <asp:Repeater ID="rptIssueList" runat="server">
                        <ItemTemplate>
                            <li><a href="/Service/AdCourseInfo.aspx?param=<%# Eval("IssueID") %>"><%# Eval("IssueTitle")%></a></li>
                        </ItemTemplate>
                    </asp:Repeater>                  
                </ul>                  
