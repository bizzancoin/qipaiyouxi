<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Course.aspx.cs" Inherits="Game.Web.Service.Course" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="/css/service/service-course.css" rel="stylesheet" type="text/css" />
      ...
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <div class="ui-main-speedy fn-left">
            <!--客服左边开始-->
            <qp:ServiceSidebar ID="sServiceSidebar" runat="server" ServicePageID="2" />
            <!--客服左边结束-->
            <!--游戏下载开始-->
          ...
          <div class="ui-main-details fn-right">
            <h2 class="ui-title-solid">新手教程</h2>
            <div class="ui-course">
              <%=contents %>
            </div>
          </div>
