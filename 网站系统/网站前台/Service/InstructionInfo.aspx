<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructionInfo.aspx.cs" Inherits="Game.Web.Service.InstructionInfo" %>
        ...
        <div class="fn-clear">
          ...
          <div class="ui-main-details fn-right">
            ...
            <div class="ui-faq-back fn-clear">
              <span class="fn-right"><a id="linLast" runat="server" class="ui-btn-1">上一篇</a>&nbsp;<a id="linNext" runat="server" class="ui-btn-1">下一篇</a>&nbsp;<a href="/Service/Instruction.aspx" title="返回列表" class="ui-btn-1">返回列表</a></span>
            </div>
          </div>
        </div>
      </div>
