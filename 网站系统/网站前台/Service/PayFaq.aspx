<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayFaq.aspx.cs" Inherits="Game.Web.Service.PayFaq" %>
              ...
              <div class="ui-faq-box">
                <ul class="ui-faq-list">
                    <asp:Repeater ID="rptIssueList" runat="server">
                        <ItemTemplate>
                            <li><a href="/Service/PayFaqInfo.aspx?param=<%# Eval("IssueID") %>"><%# Eval("IssueTitle")%></a></li>
                        </ItemTemplate>
                    </asp:Repeater>                  
                </ul>
