<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faq.aspx.cs" Inherits="Game.Web.Service.Faq" %>
              ...
              <div class="ui-faq-box">
                <ul class="ui-faq-list">
                    <asp:Repeater ID="rptIssueList" runat="server">
                        <ItemTemplate>
                            <li><a href="/Service/FaqInfo.aspx?param=<%# Eval("IssueID") %>"><%# Eval("IssueTitle")%></a></li>
                        </ItemTemplate>
                    </asp:Repeater>                  
                </ul>
