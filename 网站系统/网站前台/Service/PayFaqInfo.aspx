<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayFaqInfo.aspx.cs" Inherits="Game.Web.Service.PayFaqInfo" %>
      ...
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <div class="ui-main-speedy fn-left">
            <!--客服左边开始-->
            <qp:ServiceSidebar ID="sServiceSidebar" runat="server" ServicePageID="5" />
            <!--客服左边结束-->
            <!--游戏下载开始-->
          ...
          <div class="ui-main-details fn-right">
            <h2 class="ui-title-solid">充值帮助</h2>
            <div class="ui-faq-detail">
              <h4><%=title %></h4>
              <%=content %>
            </div>
            <div class="ui-faq-back fn-clear">
              <span class="fn-right"><a id="linLast" runat="server" class="ui-btn-1">上一篇</a>&nbsp;<a id="linNext" runat="server" class="ui-btn-1">下一篇</a>&nbsp;<a href="/Service/PayFaq.aspx" title="返回列表" class="ui-btn-1">返回列表</a></span>
            </div>
          </div>
        </div>
      </div>
