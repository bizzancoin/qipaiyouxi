<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoveLinessRank.aspx.cs" Inherits="Game.Web.Rank.LoveLinessRank" %>
      ...
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <div class="ui-main-speedy fn-left">
            <!--排行左边开始-->
            <qp:RankSidebar ID="sRankSidebar" runat="server" RankPageID="2" />
            <!--排行左边结束-->
            <!--游戏下载开始-->
          ...
          <div class="ui-main-details fn-right">
            <h2 class="ui-title-solid">魅力排行</h2>
