<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeRank.aspx.cs" Inherits="Game.Web.Rank.GradeRank" %>
      ...
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <div class="ui-main-speedy fn-left">
            <!--排行左边开始-->
            <qp:RankSidebar ID="sRankSidebar" runat="server" RankPageID="3" />
            <!--排行左边结束-->
            <!--游戏下载开始-->
          ...
          <div class="ui-main-details fn-right">
            <h2 class="ui-title-solid">等级排行</h2>
                    ...
                    <asp:Repeater ID="rptRank" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%# GetGradeConfig(Convert.ToInt32(Eval("RankValue")))%></td>
                                <td><%# Convert.ToInt32(Eval("RankValue")).ToString("N0")%></td>                  
                            </tr>
                        </ItemTemplate>
