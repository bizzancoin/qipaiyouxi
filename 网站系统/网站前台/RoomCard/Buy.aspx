<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buy.aspx.cs" Inherits="Game.Web.RoomCard.Buy" %>
          ...
          <div class="ui-main-details fn-right" style="min-height:941px;">
            ...
            <form id="form" runat="server" method="post">
              <div class="ui-exchange-info">
                <div class="ui-gold-info"><span>您的房卡数：<asp:Label ID="lbRoomCard" runat="server" Text="0"></asp:Label></span><span>您的游戏豆数：<asp:Label ID="lbCurrucy" runat="server" Text="0"></asp:Label></span></div>
                <h2 class="ui-title-solid">游戏豆购买房卡 <a href="/RoomCard/BuyByGold.aspx" class="ui-title-a">游戏币购买房卡</a></h2>
                <ul>
                  <li>
                    <label>购买数量：</label>
                      <asp:TextBox ID="txtBuyNum" runat="server" CssClass="ui-text-1" placeholder="请输入购买房卡数"></asp:TextBox>
                  </li>
                  <li>
                    <label>支付游戏豆：</label>
                      <span id="gold" data-rate="<%=rate %>" data-max="<%=maxNum %>">0</span> 游戏豆
                  </li>
                  <li >
                    <label>银行密码：</label>
                  ...
                  <li class="ui-shop-submit">
                      <asp:Button ID="btnSubmit" runat="server" Text="确定购买" CssClass="ui-btn-1" OnClick="btnSubmit_Click" />
