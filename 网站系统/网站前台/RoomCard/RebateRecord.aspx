<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RebateRecord.aspx.cs" Inherits="Game.Web.RoomCard.RebateRecord" %>
          ...
          <div class="ui-main-details fn-right">
            ...
            <div class="ui-order-detail">
              ...
              <div class="ui-order-list">
                ...
                <a href="/RoomCard/ExchRecord.aspx">兑换记录</a>
                <a href="/RoomCard/RebateRecord.aspx" class="ui-order-active">返利记录</a>
              </div>
              <div class="ui-activity-award">
                <table cellspacing="0" id="order-lists">
                  <thead>
                    <tr>
                      <th class="ui-font-weight">返利时间</th>
                      <th class="ui-font-weight">消耗房卡</th>
                      <th class="ui-font-weight">返利游戏币</th>
                      <th class="ui-font-weight">返利房间</th>
                    </tr>
                  </thead>
                  <tbody>
                      <asp:repeater id="rptData" runat="server">
                          <ItemTemplate>
                                <tr class="order-item">
                                    <td><%# Eval( "DissumeDate" )%></td>
                                    <td><%# Eval( "CreateTableFee" )%></td>
                                    <td><%# Eval( "TaxRevenue" )%></td>
                                    <td><%# Eval( "RoomID" )%></td>
                                </tr>
                            </ItemTemplate>
                      </asp:repeater>                   
