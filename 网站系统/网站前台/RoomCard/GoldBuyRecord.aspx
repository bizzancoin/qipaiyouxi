<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoldBuyRecord.aspx.cs" Inherits="Game.Web.RoomCard.GoldBuyRecord" %>
          ...
          <div class="ui-main-details fn-right">
            ...
            <div class="ui-order-detail">
              ...
              <div class="ui-order-list">
                ...
                <a href="/RoomCard/GoldBuyRecord.aspx" class="ui-order-active">游戏币购买</a>
                ...
                <table cellspacing="0" id="order-lists">
                  <thead>
                    <tr>
                      ...
                      <th class="ui-font-weight">支付前游戏币</th>
                      <th class="ui-font-weight">支付游戏币</th>
