<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Success.aspx.cs" Inherits="Game.Web.RoomCard.Success" %>
        ...
        <div class="fn-clear">
          ...
          <div class="ui-main-details fn-right">
            ...
            <div class="ui-exchange-info">
                <h2 class="ui-title-solid">操作结果</h2>
                <div class="ui-result">
                    <p>
                        <span class="ui-result-tip"></span>
