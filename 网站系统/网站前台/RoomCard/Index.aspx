<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Game.Web.RoomCard.Index" %>
          ...
          <div class="ui-main-details fn-right">
            ...
            <div class="ui-order-detail">
              ...
              <div class="ui-order-list">
                <a href="/RoomCard/Index.aspx" class="ui-order-active">游戏豆购买</a>
                ...
                <table cellspacing="0" id="order-lists">
                  <thead>
                    <tr>
                      ...
                      <th class="ui-font-weight">购买前房卡</th>
                      <th class="ui-font-weight">购买房卡</th>
                      <th class="ui-font-weight">支付前游戏豆</th>
                      <th class="ui-font-weight">支付游戏豆</th>
                      <th class="ui-font-weight">购买地址</th>
                    </tr>
                  </thead>
                  <tbody>
