<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyByGold.aspx.cs" Inherits="Game.Web.RoomCard.BuyByGold" %>
          ...
          <div class="ui-main-details fn-right" style="min-height:941px;">
            ...
            <form id="form" runat="server" method="post">
              <div class="ui-exchange-info">
                <div class="ui-gold-info"><span>您的房卡数：<asp:Label ID="lbRoomCard" runat="server" Text="0"></asp:Label></span><span>您的银行游戏币：<asp:Label ID="lbInsure" runat="server" Text="0"></asp:Label></span></div>
                <h2 class="ui-title-solid">游戏币购买房卡 <a href="/RoomCard/Buy.aspx" class="ui-title-a">游戏豆购买房卡</a></h2>
                <ul>
                  <li>
                    <label>购买数量：</label>
