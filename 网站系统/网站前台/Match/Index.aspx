          ...
          <div class="ui-main-details fn-right">
            <ul class="ui-match-list">
              <asp:Repeater ID="rptMatchList" runat="server">
                  <ItemTemplate>
                      <li>
                        <a href='/Match/MatchView.aspx?param=<%# Eval("MatchID") %>&type=<%# Eval("MatchType") %>' title="<%# Eval("MatchName")%>">
                          <img src="<%# GetMatchImageUrl(Eval("MatchImage").ToString())%>" title="<%# Eval("MatchName")%>" alt="<%# Eval("MatchName")%>">
                          <img src="/images/match/<%#GetMatchStatus((byte)Eval("MatchStatus")) %>" class="ui-match-state">
                        </a>
                      </li>
                  </ItemTemplate>
              </asp:Repeater>
