        ...
        <div class="fn-clear">
          ...
          <div class="ui-main-details fn-right">
            ...
            <div class="ui-pay-way">
              <h2 class="ui-title-solid">您选择了&nbsp;<span>易宝支付</span>&nbsp;方式</h2>
              ...
              <form id="fmStep2" runat="server" action="http://pay.jtpay.com/form/pay" method="post">
        	     <div class="ui-result">
                    ...
                    <p id="pnlContinue" runat="server">
                        <input id="btnReset1" type="button" value="继续充值" onclick="goURL('/Pay/PayYB.aspx');" class="ui-btn-1" />
                    </p>
                </div>
             </form>
            </div>
            <div class="ui-pay-alert">
              ...
              <p>1、请确保您填写的帐号正确无误。</p>
              <p>2、充值过程中，浏览器会跳转至易宝充值页面，支付成功后，会自动返回网站，如果没有跳转或是弹出充值成功的页面，请您不要关闭充值窗口。</p>
