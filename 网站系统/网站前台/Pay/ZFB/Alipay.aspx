<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alipay.aspx.cs" Inherits="Game.Web.Pay.ZFB.Alipay" %>
...
<body>
    ...
    <div class="ui-content">
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <!--左边开始-->
          <qp:PaySidebar ID="sPaySidebar" runat="server" PayID="12"/>
          <!--左边结束-->
          <div class="ui-main-details fn-right">
            ...
            <div class="ui-pay-way">
              <h2 class="ui-title-solid">您选择了&nbsp;<span>支付宝充值</span>&nbsp;方式</h2>
              ...
              <form action="https://mapi.alipay.com/gateway.do?" method="get">
        	     <div class="ui-result">
                    <p>
                        ...
                        <span class="<%= infoClass%>"><%= msg%></span>
                        <%= formData%>
                    </p>
                    <p class="<%=btClass %>">
                        <input id="btnReset1" type="button" value="继续充值" onclick="goURL('/Pay/ZFB/Alipay.aspx');" class="ui-btn-1" />
                    </p>
                </div>
             </form>
             <%= js %>
