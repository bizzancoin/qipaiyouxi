<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardReturn.aspx.cs" Inherits="Game.Web.UserService.JFT.CardReturn" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title></title>
    <style>
      body {width: 696px; height: 420px; padding: 5px; background: url("/images/pay/pay_bg.png") no-repeat;}
...
<body>
    <div class="ui-pay-menu">
      ...
      --><span class="ui-pay-menu-3"><a href="javascript:;" class="ui-pay-active">充值完成</a></span>
    </div>
