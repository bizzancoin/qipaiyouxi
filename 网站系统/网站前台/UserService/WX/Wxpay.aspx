<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wxpay.aspx.cs" Inherits="Game.Web.UserService.WX.Wxpay" %>
...
<body>
    ...
    <div class="ui-pay-content">
      <div class="ui-pay-title">您选择了&nbsp;<span>微信</span>&nbsp;方式</div>
      ...
      <form id="fmStep2" runat="server" action="/UserService/WX/WxCode.aspx" method="post">
            <div class="ui-result">
            <p>
            ...
            <p id="pnlContinue" runat="server">
                <input id="btnReset1" type="button" value="继续充值" onclick="goURL('/UserService/WX/Wxpay.aspx');" class="ui-pay-btn-go" />
            </p>
        </div>
     </form>
      <%= js %>
