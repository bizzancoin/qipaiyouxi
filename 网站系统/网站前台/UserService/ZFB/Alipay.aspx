<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alipay.aspx.cs" Inherits="Game.Web.UserService.ZFB.Alipay" %>
...
<body>
    ...
    <div class="ui-pay-content">
      <div class="ui-pay-title">您选择了&nbsp;<span>官方支付宝</span>&nbsp;方式</div>
      ...
      <form action="https://mapi.alipay.com/gateway.do?" method="get">
            <div class="ui-result" id="hidDiv" runat="server">
            <p>
            ...
            <p>
                <input id="btnReset1" type="button" value="继续充值" onclick="goURL('/UserService/ZFB/Alipay.aspx');" class="ui-pay-btn-go" />
            </p>
        </div>
     </form>
      <%= js %>
