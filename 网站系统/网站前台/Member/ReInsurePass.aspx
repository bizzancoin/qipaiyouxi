<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReInsurePass.aspx.cs" Inherits="Game.Web.Member.ReInsurePass" %>
...
<body>
    ...
    <div class="ui-content">
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <!--左边开始-->
          <qp:UserSidebar ID="sUserSidebar" runat="server" MemberID="10" />
          <!--左边结束-->
          <div class="ui-main-details fn-right">
            <h2 class="ui-title-solid">找回银行密码</h2>            
