<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentPayInfo.aspx.cs" Inherits="Game.Web.Member.AgentPayInfo" %>
...
<body>
    ...
    <div class="ui-content">
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <!--左边开始-->
          <qp:UserSidebar ID="sUserSidebar" runat="server" MemberID="29" />
          <!--左边结束-->
                    ...
                    <asp:Repeater ID="rptSpreaderList" runat="server">
                        <ItemTemplate>
                            <tr class="ui-bg-color">
                                ...
                                <td><%#Game.Utils.TextUtility.CutString(GetNickNameByUserID((int)Eval( "ChildrenID" )),0,10)%></td>
                                <td><%# Eval("PayScore") %></td>
                                <td><%# Eval("CollectIP") %></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>                    
