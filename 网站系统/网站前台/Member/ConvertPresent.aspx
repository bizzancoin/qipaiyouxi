<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConvertPresent.aspx.cs" Inherits="Game.Web.Member.ConvertPresent" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#txtPresent")
                .formValidator({required: true,onError:"魅力值不能为空",tipCss:{left: 139}})
                .regexValidator({regExp:"intege1",dataType:"enum",onError:"兑换的魅力必须为正整数"});
        });
    </script>
</head>
<body>
    ...
    <div class="ui-content">
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <!--左边开始-->
          <qp:UserSidebar ID="sUserSidebar" runat="server" MemberID="17" />
          <!--左边结束-->
          <div class="ui-main-details fn-right">
            <div>
              ...
              <ul class="ui-balance-detail fn-clear">
                ...
                <li><p><span>总魅力值：</span><asp:Literal ID="lblTotalLoves" runat="server"></asp:Literal></p></li>
                <li><p><span>已兑换魅力值：</span><asp:Literal ID="lblExchangeLoves" runat="server"></asp:Literal></p></li>
                <li><p><span>剩余魅力值：</span><span class="ui-color-red"><asp:Literal ID="lblUnExchangeLoves" runat="server"></asp:Literal></span></p></li>
                <li><p><span>银行游戏币值：</span><span class="ui-color-red"><asp:Literal ID="lblInsureScore" runat="server" Text="0"></asp:Literal></span></p></li>
              </ul>
            </div>
            <form class="ui-spread-balance" id="form1" name="form1" runat="server">
              <p>将&nbsp;<asp:TextBox ID="txtPresent" runat="server" CssClass="ui-text-1" autocomplete="off" MaxLength="8"></asp:TextBox>&nbsp;魅力点兑换成游戏币</p>
