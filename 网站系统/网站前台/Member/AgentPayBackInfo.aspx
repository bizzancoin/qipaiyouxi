<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentPayBackInfo.aspx.cs" Inherits="Game.Web.Member.AgentPayBackInfo" %>
...
<body>
    ...
    <div class="ui-content">
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <!--左边开始-->
          <qp:UserSidebar ID="sUserSidebar" runat="server" MemberID="31" />
          <!--左边结束-->
                    ...
                    <asp:Repeater ID="rptSpreaderList" runat="server">
                        <ItemTemplate>
                            <tr class="ui-bg-color">
                                ...
                                <td><%# Eval("Score") %></td>
                                <td><%# (int)((decimal)Eval( "PayBackScale" )*1000) %>‰</td>
                                <td><%# Eval("PayScore") %></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>                    
