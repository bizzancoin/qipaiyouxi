<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsureOut.aspx.cs" Inherits="Game.Web.Member.InsureOut" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#txtInsurePass")
                .formValidator({ required: true, onEmpty: "密码不能为空！" });
        });
    </script>
</head>
<body>
    ...
    <div class="ui-content">
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <!--左边开始-->
          <qp:UserSidebar ID="sUserSidebar" runat="server" MemberID="14" />
          <!--左边结束-->
          <div class="ui-main-details fn-right">
            <form name="form1" id="form1" runat="server">
              ...
              <div class="ui-deposit">
                <h2 class="ui-title-solid">取出游戏币</h2>
                <p><span>游戏币数目：</span><asp:TextBox ID="txtScore" runat="server" CssClass="ui-text-1" Text="0"></asp:TextBox></p>
                <p><span>银行密码：</span><asp:TextBox ID="txtInsurePass" runat="server" CssClass="ui-text-1" TextMode="Password"></asp:TextBox></p>
                <p><span>备注信息：</span><asp:TextBox ID="txtNote" runat="server" TextMode="MultiLine"></asp:TextBox></p>
                <p><asp:Button ID="btnUpdate" Text="取出游戏币" runat="server" CssClass="ui-btn-1" onclick="btnUpdate_Click" /></p>
              </div>
              <div class="ui-deposit-tips">
                <h2 class="ui-title-solid">温馨提示</h2>
                <p>1.如果您在游戏币类游戏中，您将不能够取出游戏币。</p>
