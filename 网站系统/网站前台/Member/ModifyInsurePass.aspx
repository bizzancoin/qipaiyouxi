<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyInsurePass.aspx.cs" Inherits="Game.Web.Member.ModifyInsurePass" %>
...
<body>
    ...
    <div class="ui-content">
      <div class="ui-main">
        ...
        <div class="fn-clear">
          <!--左边开始-->
          <qp:UserSidebar ID="sUserSidebar" runat="server" MemberID="5" />
          <!--左边结束-->
