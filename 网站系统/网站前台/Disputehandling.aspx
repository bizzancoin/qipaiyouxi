<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Disputehandling.aspx.cs" Inherits="Game.Web.Disputehandling" %>
...
<head runat="server">
    ...
    <link href="/css/dispute/dispute-handling.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <!--头部开始-->
    ...
    <div class="ui-content">
      <div class="ui-main">
        <div class="ui-page-title fn-clear">
          ...
          <span>交易纠纷处理</span>
          <div class="ui-page-title-right"><span>DISPUTE & HANDLING</span><strong>交易纠纷处理</strong></div>
        </div>
        <div class="fn-clear">
