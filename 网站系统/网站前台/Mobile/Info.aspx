<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info.aspx.cs" Inherits="Game.Web.Mobile.Info" %>
<html>
    <head runat="server">
        <title><%=model.KindName %></title>
    ...
    <body>
     <div class="ui-head"><a href="/Mobile/"><img src="/Mobile/Img/mobile/left.png"/></a><strong><%= model.KindName %></strong></div>
        <div class="ui-mobile-box fn-clear">
            <div class="ui-game-info fn-clear">
                <div class="ui-game-pic fn-left"><img src="<%= Game.Facade.Fetch.GetUploadFileUrl(model.ThumbnailUrl)%>"/><span><%= model.KindName %></span></div>
               <div class="ui-download-button"><a href="<%= terminalType==2?model.IOSDownloadUrl:model.AndroidDownloadUrl %>" class="ui-button">立即下载</a></div>
            </div>
            <div class="ui-details fn-clear">
                <h1>游戏截图</h1>
                <div class="ui-screenshot" style="visibility: visible;">
                    <div class='ui-screenshot-wrap'>
                        <div><img src="<%= Game.Facade.Fetch.GetUploadFileUrl(model.MobileImgUrl)%>"/></div>
                    </div>
                    <ul class="ui-screenshot-nav"></ul>
                </div>
                <h3>内容介绍</h3>
                <div class="ui-introduction"><%= model.HelpIntro %></div>
                <h3>相关推荐</h3>
