...
BEGIN
	...
	FROM AccountsInfo(NOLOCK) WHERE UserUin=@strUserUin	

	IF @UserID IS NOT NULL
	BEGIN
		SET @strErrorDescribe=N'此帐号名已被注册，请更换另一帐号名后尝试再次申请！'
		RETURN 100
	END
	...
	VALUES (@strTemp,@strTempName,@strTemp,@strUserUin,N'd1fd5495e7b727081497cfce780b6456',N'',@SpreaderID,@cbGender,0,1,@strClientIP,@strClientIP,0x50,5)
